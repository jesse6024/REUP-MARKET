...
<head>
      ...
      <sript type="text/javascript" src="http://code.jquery.com/jquery-1.8.2.js"></scritp>
      ...
      <script type="text/javascript">
        $('username').keyup(function()
        {
          ...
          {
               $('#username').fadeOut();
               setTimeout("closeajax('username, '"+escape(response)+"')",380";
          });
          return false;
        });
...
">
            ...
            <input type="text" name="username" required value="" id="username" placeholder="Username" style="
                                    ...
                                    /* padding-top: 30px; */
                                        margin-top: 30px;
    "> 
    <!--Javascript Code That Needs Fixing -->
    <?php include ('avail_user.php') ?>
    <script type="text/javascript">
        $('username').keyup(function()
        {
          $.post("avail_user.php",
